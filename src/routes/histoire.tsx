...
function HistoirePage() {
  return (
    <PageShell>
      ...
      <section className="mx-auto grid max-w-6xl gap-6 px-4 py-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <figure className="poster-border overflow-hidden rounded-[1.75rem] bg-card">
          <img
        ...
        <div className="max-w-xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-[#fff0c7] px-4 py-2 text-sm font-semibold">
          ...
          <p className="mt-5 leading-7 text-muted-foreground">
            ...
            L'expérience a été imaginée pour créer à son rythme, autour d'un café, d'un bagel, d'une
            pâtisserie ou d'un brunch.
          </p>
          <p className="mt-4 leading-7 text-muted-foreground">
            Ici, les grandes tables se partagent, les idées circulent et chaque pièce raconte
            quelque chose de différent. Le lieu vit grâce aux créations, à l'équipe et aux personnes
            qui reviennent découvrir leur céramique après cuisson.
          </p>
        </div>
      </section>
      ...
      <section className="checker-strong border-y border-ink/20 px-4 py-12">
        <div className="mx-auto grid max-w-6xl gap-4 sm:grid-cols-3">
          {[
            ...
            <article key={title} className="rounded-2xl border-2 border-ink bg-[#fff8ef] p-5">
      ...
      <section className="mx-auto grid max-w-6xl gap-4 px-4 py-12 sm:grid-cols-3">
        ...
        <img
          ...
          className="aspect-[4/5] w-full rounded-3xl object-cover sm:translate-y-7"
        />
        <img
        ...
        <Link
          to="/reserver"
          className="mt-6 inline-flex w-fit items-center gap-2 rounded-full bg-primary px-5 py-3 font-semibold text-primary-foreground sm:col-span-3 sm:justify-self-center"
        >
